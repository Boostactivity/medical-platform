// Service Worker Exp'Air Medical - Mode Hors-Ligne
// Version 1.0.0

const CACHE_VERSION = 'expair-v1.0.0';
const CACHE_NAME = `expair-medical-${CACHE_VERSION}`;
...
function getOfflineHTML() {
  return `
    ...
    <head>
      ...
      <title>Exp'Air Medical - Hors ligne</title>
      <style>
