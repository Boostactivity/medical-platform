...
const MOCK_SITES: Site[] = [
  {
    ...
    email: 'paris-centre@expair.fr',
    responsable: 'Marie Dupont',
    zoneGeographique: 'Paris 1-4, 5-8',
    techniciens: [
      { id: 't1', nom: 'Martin', prenom: 'Lucas', email: 'l.martin@expair.fr', phone: '06 00 00 01' },
      { id: 't2', nom: 'Bernard', prenom: 'Sophie', email: 's.bernard@expair.fr', phone: '06 00 00 02' },
      { id: 't3', nom: 'Petit', prenom: 'Thomas', email: 't.petit@expair.fr', phone: '06 00 00 03' },
    ],
  ...
  },
  {
    ...
    email: 'lyon@expair.fr',
    responsable: 'Pierre Roux',
    zoneGeographique: 'Lyon metropole, Villeurbanne',
    techniciens: [
      { id: 't4', nom: 'Durand', prenom: 'Julie', email: 'j.durand@expair.fr', phone: '06 00 00 04' },
      { id: 't5', nom: 'Moreau', prenom: 'Antoine', email: 'a.moreau@expair.fr', phone: '06 00 00 05' },
    ],
  ...
  },
  {
    ...
    email: 'marseille@expair.fr',
    responsable: 'Isabelle Garcia',
    zoneGeographique: 'Marseille, Aix-en-Provence',
    techniciens: [
      { id: 't6', nom: 'Simon', prenom: 'Claire', email: 'c.simon@expair.fr', phone: '06 00 00 06' },
    ],
  ...
  },
  {
    ...
    email: 'bordeaux@expair.fr',
    responsable: 'Jean Lefebvre',
    zoneGeographique: 'Bordeaux Metropole',
    techniciens: [
      { id: 't7', nom: 'Laurent', prenom: 'Marc', email: 'm.laurent@expair.fr', phone: '06 00 00 07' },
      { id: 't8', nom: 'Leroy', prenom: 'Emma', email: 'e.leroy@expair.fr', phone: '06 00 00 08' },
    ],
            ...
            >
              ...
              <div className="space-y-3">
                {([
                  ...
                  { key: 'email', label: 'Email', placeholder: 'nice@expair.fr' },
