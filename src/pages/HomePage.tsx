...
export function HomePage() {
  ...
  return (
    <div className="bg-white dark:bg-background">
      ...
      <section className="relative flex items-center justify-center px-6 pt-24 pb-20 lg:pt-32 lg:pb-32 overflow-hidden">
        ...
        <div className="max-w-6xl w-full relative z-10">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, ease: [0.22, 1, 0.36, 1] }} className="text-center">
            ...
            <h1 className="text-2xl sm:text-4xl md:text-6xl lg:text-7xl leading-[1.05] text-[#1a2b3c] dark:text-foreground mb-6 max-w-4xl mx-auto font-light tracking-tight">
            ...
            <p className="text-lg md:text-xl text-gray-500 dark:text-muted-foreground max-w-2xl mx-auto leading-relaxed mb-10 font-light">
              {t('homepage.heroSubtitle')}
            </p>

            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
              <Link to="/contact" className="bg-gradient-to-r from-blue-600 to-violet-600 text-white px-8 py-3.5 min-h-12 rounded-xl text-base font-medium hover:shadow-lg hover:shadow-blue-500/25 transition-all inline-flex items-center justify-center">
                {t('homepage.ctaButton')}
              </Link>
              <Link to="/apnee-sommeil" className="border border-gray-200 dark:border-border text-gray-700 dark:text-foreground px-8 py-3.5 min-h-12 rounded-xl text-base font-medium hover:bg-gray-50 dark:hover:bg-accent transition-all inline-flex items-center justify-center">
      ...
      {/* Cards Section */}
      <section className="py-20 lg:py-28 px-6 bg-[#f8fafc] dark:bg-secondary">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <motion.div key={card.to} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: index * 0.1 }}>
                <Link to={card.to} className={`group block bg-gradient-to-br ${card.gradient} bg-white dark:bg-card border border-gray-100 dark:border-border p-8 rounded-2xl hover:shadow-lg hover:border-gray-200 transition-all text-center`}>
                  ...
                  <h3 className="text-base font-medium text-[#1a2b3c] dark:text-foreground mb-2">{card.title}</h3>
                  <p className="text-sm text-gray-500 dark:text-muted-foreground">{card.subtitle}</p>
                </Link>
              </motion.div>
            ))}
          </div>
      ...
      <section className="py-20 lg:py-32 px-6 bg-white dark:bg-background">
        <div className="max-w-6xl mx-auto">
          <motion.div {...fadeInUp} className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-light text-[#1a2b3c] dark:text-foreground mb-4 tracking-tight">{t('homepage.howItWorksTitle')}</h2>
            <p className="text-lg text-gray-500 dark:text-muted-foreground max-w-2xl mx-auto font-light">{t('homepage.howItWorksSubtitle')}</p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              ...
              <motion.div key={step.num} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: index * 0.1 }} className="text-center">
                ...
                <h3 className="text-base font-medium text-[#1a2b3c] dark:text-foreground mb-2">{step.title}</h3>
                <p className="text-sm text-gray-500 dark:text-muted-foreground leading-relaxed">{step.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      {/* For Patients */}
      <section className="py-20 lg:py-32 px-6 bg-[#f8fafc] dark:bg-secondary">
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div {...fadeInUp}>
              ...
              <h2 className="text-3xl md:text-4xl font-light text-[#1a2b3c] dark:text-foreground mb-4 tracking-tight">{t('homepage.forPatientsTitle')}</h2>
              <p className="text-lg text-gray-500 dark:text-muted-foreground mb-8 font-light">{t('homepage.forPatientsSubtitle')}</p>
              <ul className="space-y-4">
                {[t('homepage.patientFeature1'), t('homepage.patientFeature2'), t('homepage.patientFeature3'), t('homepage.patientFeature4')].map((f) => (
                  <li key={f} className="flex items-center gap-3">
                    ...
                    <span className="text-[#1a2b3c] dark:text-foreground text-sm">{f}</span>
                  </li>
                ))}
              </ul>
            </motion.div>
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }}>
              <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <div className="text-sm font-medium text-[#1a2b3c] dark:text-foreground">Score de sante</div>
                  ...
                  {[
                    ...
                    <div key={m.label}>
                      <div className="flex items-center justify-between mb-1">
                        <span className="text-xs text-gray-500 dark:text-muted-foreground">{m.label}</span>
                        <span className="text-xs font-medium text-[#1a2b3c] dark:text-foreground">{m.value}</span>
                      </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }} className="order-2 lg:order-1">
              <div className="bg-[#f8fafc] dark:bg-secondary rounded-2xl border border-gray-100 p-8">
                <div className="flex items-center justify-between mb-6">
                  <h4 className="text-sm font-medium text-[#1a2b3c] dark:text-foreground">Patients suivis</h4>
                  ...
                  {[
                    ...
                    <div key={p.name} className="flex items-center justify-between bg-white rounded-xl p-3 border border-gray-50">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-sm text-[#1a2b3c] dark:text-foreground">{p.name}</span>
                      </div>
                      <div className="flex items-center gap-4">
                        <span className="text-xs text-gray-500 dark:text-muted-foreground">{p.status}</span>
                        <span className="text-xs font-medium text-[#1a2b3c] dark:text-foreground">{p.hours}</span>
                      </div>
                    </div>
                  ))}
                </div>
            ...
            <motion.div {...fadeInUp} className="order-1 lg:order-2">
              ...
              <h2 className="text-3xl md:text-4xl font-light text-[#1a2b3c] dark:text-foreground mb-4 tracking-tight">{t('homepage.forDoctorsTitle')}</h2>
              <p className="text-lg text-gray-500 dark:text-muted-foreground mb-8 font-light">{t('homepage.forDoctorsSubtitle')}</p>
              <ul className="space-y-4">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div {...fadeInUp}>
              ...
              <h2 className="text-3xl md:text-4xl font-light text-[#1a2b3c] dark:text-foreground mb-4 tracking-tight">{t('homepage.forProvidersTitle')}</h2>
              <p className="text-lg text-gray-500 dark:text-muted-foreground mb-8 font-light">{t('homepage.forProvidersSubtitle')}</p>
              <ul className="space-y-4">
              ...
              <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8">
                <div className="grid grid-cols-2 gap-4">
                  {[
                    ...
                    <div key={m.label} className="bg-[#f8fafc] dark:bg-secondary rounded-xl p-4">
                      <div className="text-xs text-gray-500 dark:text-muted-foreground mb-1">{m.label}</div>
                      <div className="text-xl font-medium text-[#1a2b3c] dark:text-foreground">{m.value}</div>
      ...
      <section className="py-20 lg:py-32 px-6 bg-white dark:bg-background">
        <div className="max-w-6xl mx-auto">
          <motion.div {...fadeInUp} className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-light text-[#1a2b3c] dark:text-foreground mb-4 tracking-tight">{t('homepage.statsTitle')}</h2>
            <p className="text-lg text-gray-500 dark:text-muted-foreground font-light">{t('homepage.statsSubtitle')}</p>
          </motion.div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              ...
              <motion.div key={stat.label} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: index * 0.1 }}>
                ...
                <div className="text-sm font-medium text-[#1a2b3c] dark:text-foreground mb-1">{stat.label}</div>
                <div className="text-xs text-gray-500 dark:text-muted-foreground">{stat.sub}</div>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 lg:py-32 px-6 bg-[#f8fafc] dark:bg-secondary">
        <div className="max-w-6xl mx-auto">
          <motion.div {...fadeInUp} className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-light text-[#1a2b3c] dark:text-foreground mb-4 tracking-tight">{t('homepage.testimonialsTitle')}</h2>
            <p className="text-lg text-gray-500 dark:text-muted-foreground font-light">{t('homepage.testimonialsSubtitle')}</p>
          </motion.div>
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <motion.div key={index} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: index * 0.1 }} className="bg-white dark:bg-card border border-gray-100 dark:border-border rounded-2xl p-8 shadow-sm">
                ...
                <div>
                  <div className="text-sm font-medium text-[#1a2b3c] dark:text-foreground">{testimonial.author}</div>
                  <div className="text-xs text-gray-500 dark:text-muted-foreground">{testimonial.role}</div>
                </div>
              </motion.div>
            ))}
          </div>
      ...
      <section className="py-20 lg:py-32 px-6 bg-white dark:bg-background">
        <div className="max-w-6xl mx-auto text-center">
          <motion.div {...fadeInUp}>
            <h2 className="text-3xl md:text-4xl font-light text-[#1a2b3c] dark:text-foreground mb-4 tracking-tight">{t('homepage.connectorsTitle')}</h2>
            <p className="text-lg text-gray-500 dark:text-muted-foreground font-light mb-12">{t('homepage.connectorsSubtitle')}</p>
          </motion.div>
      ...
      <section className="py-20 lg:py-32 px-6 bg-white dark:bg-background">
        <div className="max-w-4xl mx-auto text-center">
          <motion.div {...fadeInUp}>
            <h2 className="text-3xl md:text-4xl font-light text-[#1a2b3c] dark:text-foreground mb-4 tracking-tight">{t('homepage.ctaTitle')}</h2>
            <p className="text-lg text-gray-500 dark:text-muted-foreground mb-10 font-light">{t('homepage.ctaSubtitle')}</p>
