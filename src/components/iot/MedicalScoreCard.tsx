/**
 * Carte Score Medical - Affichage principal du score quotidien
...
export function MedicalScoreCard({ score, grade, trend, date, previousScore }: MedicalScoreCardProps) {
  // Couleur selon grade
  const gradeColors = {
    ...
    <div className="relative overflow-hidden rounded-3xl bg-white shadow-lg border border-gray-100 p-8">
      ...
      <div className="relative">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <p className="text-sm text-gray-500">Score Medical</p>
