      ...
      <section className="py-24 bg-white dark:bg-background">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <motion.div {...fadeInUp} className="prose prose-lg max-w-none">
            {/* Mentions légales */}
            <div className="mb-16">
              <h2 className="text-3xl text-[#1a2b3c] dark:text-foreground mb-6 flex items-center gap-3">
                <Shield className="w-8 h-8 text-[#3b82f6]" />
                Mentions légales
              </h2>
              
              <div className="bg-[#f8fafc] dark:bg-secondary rounded-2xl p-8 space-y-6">
                <div>
                  <h3 className="text-xl text-[#1a2b3c] dark:text-foreground mb-2">Éditeur du site</h3>
                  <p className="text-[#6b7280] dark:text-muted-foreground">
                    ...
                    <strong>Email :</strong> contact@plateforme.fr<br />
                    <strong>Téléphone :</strong> 01 XX XX XX XX
                  </p>
                </div>

                <div>
                  <h3 className="text-xl text-[#1a2b3c] dark:text-foreground mb-2">Directeur de publication</h3>
                  <p className="text-[#6b7280] dark:text-muted-foreground">
                ...
                <div>
                  <h3 className="text-xl text-[#1a2b3c] dark:text-foreground mb-2">Hébergement</h3>
                  <p className="text-[#6b7280] dark:text-muted-foreground">
                ...
                <div>
                  <h3 className="text-xl text-[#1a2b3c] dark:text-foreground mb-2">Agréments</h3>
                  <p className="text-[#6b7280] dark:text-muted-foreground">
            ...
            <div className="mb-16" id="confidentialite">
              ...
              <div className="space-y-8">
                <div className="bg-[#f8fafc] dark:bg-secondary rounded-2xl p-8">
                  <h3 className="text-xl text-[#1a2b3c] dark:text-foreground mb-4">Collecte des données personnelles</h3>
                  ...
                  <ul className="list-disc list-inside text-[#6b7280] dark:text-muted-foreground space-y-2">
                ...
                <div className="bg-[#f8fafc] dark:bg-secondary rounded-2xl p-8">
                  <h3 className="text-xl text-[#1a2b3c] dark:text-foreground mb-4">Finalités du traitement</h3>
                  <p className="text-[#6b7280] dark:text-muted-foreground mb-4">
                ...
                <div className="bg-[#f8fafc] dark:bg-secondary rounded-2xl p-8">
                  <h3 className="text-xl text-[#1a2b3c] dark:text-foreground mb-4">Base légale</h3>
                  <p className="text-[#6b7280] dark:text-muted-foreground">
                ...
                <div className="bg-[#f8fafc] dark:bg-secondary rounded-2xl p-8">
                  <h3 className="text-xl text-[#1a2b3c] dark:text-foreground mb-4">Destinataires des données</h3>
                  <p className="text-[#6b7280] dark:text-muted-foreground mb-4">
                ...
                <div className="bg-[#f8fafc] dark:bg-secondary rounded-2xl p-8">
                  <h3 className="text-xl text-[#1a2b3c] dark:text-foreground mb-4">Sécurité des données</h3>
                  <p className="text-[#6b7280] dark:text-muted-foreground">
                ...
                <div className="bg-[#f8fafc] dark:bg-secondary rounded-2xl p-8">
                  <h3 className="text-xl text-[#1a2b3c] dark:text-foreground mb-4">Durée de conservation</h3>
                  <p className="text-[#6b7280] dark:text-muted-foreground">
                ...
                <div className="bg-[#f8fafc] dark:bg-secondary rounded-2xl p-8">
                  <h3 className="text-xl text-[#1a2b3c] dark:text-foreground mb-4">Vos droits</h3>
                  <p className="text-[#6b7280] dark:text-muted-foreground mb-4">
                  ...
                  <p className="text-[#6b7280] dark:text-muted-foreground mt-4">
            ...
            <div className="mb-16" id="donnees-sante">
              <h2 className="text-3xl text-[#1a2b3c] dark:text-foreground mb-6">Protection des données de santé</h2>
              
              <div className="bg-[#3b82f6]/10 border-2 border-[#3b82f6]/30 rounded-2xl p-8">
                <p className="text-[#1a2b3c] dark:text-foreground mb-4">
            ...
            {/* Cookies */}
            <div className="mb-16">
              <h2 className="text-3xl text-[#1a2b3c] dark:text-foreground mb-6">Cookies et traceurs</h2>
              
              <div className="bg-[#f8fafc] dark:bg-secondary rounded-2xl p-8">
                <p className="text-[#6b7280] dark:text-muted-foreground mb-4">
                  Notre site utilise des cookies pour :
                </p>
                <ul className="list-disc list-inside text-[#6b7280] dark:text-muted-foreground space-y-2 mb-4">
            ...
            {/* Contact */}
            <div className="bg-[#f8fafc] dark:bg-secondary rounded-2xl p-8">
              <h3 className="text-2xl text-[#1a2b3c] dark:text-foreground mb-4">Contact</h3>
              <p className="text-[#6b7280] dark:text-muted-foreground">
                Pour toute question concernant vos données personnelles :<br />
                <strong>Délégué à la Protection des Données (DPO)</strong><br />
                Email : dpo@plateforme.fr<br />
                Courrier : la plateforme - DPO, Paris, France
              </p>
            </div>

            <p className="text-sm text-[#6b7280] dark:text-muted-foreground mt-8">
