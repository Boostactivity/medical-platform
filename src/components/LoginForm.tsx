    ...
    try {
      ...
      if (data.session) {
        ...
        if (userRole !== userType) {
          setError(`Ce compte n'est pas un compte ${userTypeLabels[userType]}.${!userRole ? ' Le rôle du compte n\'est pas défini — contactez votre prestataire.' : ''}`);
          setLoading(false);
  ...
  return (
    <div className="w-full max-w-md">
      <div className="bg-white rounded-3xl shadow-2xl p-8 lg:p-12">
        <h2 className="text-3xl text-[#1A1A1A] mb-2 text-center">Connexion</h2>
        <p className="text-[#5C5C5C] text-center mb-8">Espace {userTypeLabels[userType]}</p>
          ...
          <div className="mb-8">
            ...
            <div className="relative my-8">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-white text-[#5C5C5C]">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <div className="relative">
              <Mail className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-[#5C5C5C]" />
              <input
                id="email"
                type="email"
                value={email}
                ...
                required
                className="w-full pl-12 pr-4 py-3 bg-[#F2F0EB] border-2 border-transparent rounded-xl focus:border-[#007AFF] focus:bg-white transition-all outline-none"
          ...
          <div>
            ...
            <div className="relative">
              <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-[#5C5C5C]" />
              <input
                id="password"
                ...
                required
                className="w-full pl-12 pr-12 py-3 bg-[#F2F0EB] border-2 border-transparent rounded-xl focus:border-[#007AFF] focus:bg-white transition-all outline-none"
                placeholder="••••••••"
              />
              <button
                type="button"
                onClick={() => setShowPassword(!showPassword)}
                className="absolute right-4 top-1/2 -translate-y-1/2 text-[#5C5C5C] hover:text-[#007AFF] transition-colors"
              >
          ...
          {/* Error */}
          {error && (
            <div className="flex items-center gap-2 p-4 bg-[#CE0500]/10 border border-[#CE0500]/30 rounded-xl text-[#CE0500]">
